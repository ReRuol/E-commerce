                ...
                <div className={Css['search-header']}>
                    ...
                    <div className={Css['search-wrap']}>
                        <div className={Css['search-input-wrap']}>
                            ...
                            defaultValue={this.props.keywords} onChange={(e)=>{this.setState({keywords:e.target.value})}} 
                            ref="keywords"/>
                        </div>
                        <button type="button" className={Css['search-btn']} onClick={this.addHistoryKeywords.bind(this)}></button>
                    </div>
                </div>
                <div className={this.state.bHistory?Css['search-main']:Css['hide']}>
