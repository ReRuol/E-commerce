    ...
    render(){
        return(
            <div className={Css['page']}>
                <div className=
                /* {this.state.bScroll?Css['search-header']+" "+Css["red-bg"]:Css['search-header']} */
                        ...
                        this.state.aNav.map((item,index)=>{
                            return(
                                <ul key={index} className={Css['item']}>
                                    <li className={Css['item-img']}><img src={item.image} 
                                    onClick={this.pushPage.bind(this,"goods/classify/items?cid="+item.cid)} alt={item.title}/></li>
                                        ...
                                        <div className={Css['goods-level1-wrap']}>
                                            {item.items!=null?
                                                item.items.slice(0,2).map((item2,index2)=>{
                                                    return(
                                                        <div key={index2} onClick={this.pushPage.bind(this,"goods/details/item?gid="+item2.gid)} className={Css['goods-level1-item0']}>
