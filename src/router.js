...
const ModPwdIndex=asyncComponents(()=>import('./pages/user/password/index'));
const MyFavIndex=asyncComponents(()=>import('./pages/user/myfav/index'));
const Transfer=asyncComponents(()=>import('./pages/transfer/index.js'));
                ...
                <Router>
                    <React.Fragment>
                        <Switch>
                            ...
                            <AuthRoute path={config.path+"user/modpwd/index"} component={ModPwdIndex} ></AuthRoute>
                            <AuthRoute path={config.path+"user/myfav/index"} component={MyFavIndex} ></AuthRoute>
